...
Also includes SymPy-backed diagnostic checks for Laws 2–6.
"""
...
# ─────────────────────────────────────────────────────────────
# Helpers for the 6 deterministic diagnostic checks
# ─────────────────────────────────────────────────────────────
...
def _detect_step_order(
    ...
    all_steps = list(dict.fromkeys(raw_steps + line_steps))
...
def _detect_inequality_direction(
    ...
    inequality_lines: list[tuple[str, float, str]] = []
    for line in lines:
