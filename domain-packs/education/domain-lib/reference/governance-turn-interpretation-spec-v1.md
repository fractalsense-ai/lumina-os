...
- `domain-packs/education/controllers/governance_adapters.py` — interpreter implementation
- `domain-packs/education/prompts/governance-turn-interpretation-spec-v1.md` — SLM prompt text
- `domain-packs/education/cfg/admin-operations.yaml` — operation definitions
- `domain-packs/education/cfg/runtime-config.yaml` — module routing and local_only flags
