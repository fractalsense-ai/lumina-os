...
This directory contains the education domain's **domain lib** — the set of estimators that feed the compressed state for education-domain sessions.

Each component is a deterministic heuristic that takes structured evidence as input and produces an updated state value. No ML models are used.
