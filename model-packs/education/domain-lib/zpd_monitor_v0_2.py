...
Conforms to (paths relative to repository root):
    model-packs/education/domain-lib/zpd-monitor-spec-v1.md
    model-packs/education/domain-lib/compressed-state-estimators.md
  model-packs/education/schemas/compressed-state-schema-v1.json
