...
`model-packs/education/reference-implementations/nlp-pre-interpreter.py`
...
- `model-packs/education/reference-implementations/runtime-adapters.py` — calls `nlp_preprocess` before the LLM, formats anchors into `context_hint`
- `model-packs/education/prompts/turn-interpretation.md` — LLM prompt that acknowledges NLP anchors
