...
- `model-packs/education/domain-lib/vocabulary_growth_monitor_v0_1.py` — Implementation
- `src/web/services/vocabularyAnalyzer.ts` — Client-side complexity analyzer
- `model-packs/education/controllers/api_handlers.py` — Domain API route handlers
