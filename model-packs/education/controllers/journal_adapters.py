...
def journal_domain_step(
    ...
    try:
        ...
        check_relational_deviation = _load_assistant_affect_monitor().check_relational_deviation
    ...
    try:
        ...
        check_shape_deviation = _load_assistant_affect_monitor().check_shape_deviation
