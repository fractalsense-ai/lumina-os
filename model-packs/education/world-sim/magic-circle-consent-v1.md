...
The education domain's consent template uses the following substitutions: participant → "student/learner," guardian/proxy → "parent or guardian," Domain Authority → "teacher," assessments → "grades." The education domain's full consent form is in `model-packs/education/`.
